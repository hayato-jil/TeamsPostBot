...
def _listbox_options(page: Page) -> Optional[Locator]:
    listbox = _query_any(page, [
        "[role='listbox']",
        "[data-tid*='people-picker'] [role='listbox']",
        "[id*='Dropdown'] [role='listbox']",
    ])
    return (listbox.locator("[role='option']") if listbox else _query_any(page, ["[role='option']"]))
